  ...
  <div class="header-con"  [ngStyle]="{'background-color': isHeaderTransparent? 'transparent': ' #1e2125'}">
    <div class="header__menus-logo-wrap">
      <div class="header__logo">
        <a routerLink="" class="text-[28px]"><img src="/assets/header/sp_logo.png" alt=""></a>
      </div>
      <!--    nav-bars -->
...
export class HeaderComponent {
  ...
  navBarMenusInfo:any[]= [
    ...
    {firstNav: 'Courses',
      secondNav:[{title:'Career Seekers', routerLink: 'careerSeekers'},{title:'Military Spouse', routerLink: 'military-spouse'}, {title:'College Students', routerLink: 'college-students'},{title:'Remote Job Seekers', routerLink: 'remote-job-seekers'}]},
    {firstNav: 'Resources',
